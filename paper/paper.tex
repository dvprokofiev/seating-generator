...
\begin{document}
	...
	\section*{Приложение 1. Код функции, запускающий меметический алгоритм}
	\addcontentsline{toc}{section}{Приложение 1. Код функции, запускающий меметический алгоритм}
	...
	\section*{Приложение 2. Файл package.json, содержащий библиотеки, необходимые для сборки фронтенда}
	\addcontentsline{toc}{section}{Приложение 2. Файл package.json, содержащий библиотеки, необходимые для сборки фронтенда}
	\begin{minted}{go}
		{
			"name": "frontend",
			"private": true,
